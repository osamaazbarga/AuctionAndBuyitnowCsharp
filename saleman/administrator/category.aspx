<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category.aspx.cs" Inherits="saleman.administrator.category" MasterPageFile="~/administrator/adminmasterpage.Master" %>
                                ...
                                <table align="center" class="auto-style1">
                                    <tr>
                                        <td class="auto-style3"><strong>
                                            <asp:Label ID="Label1" runat="server" CssClass="auto-style2" Text="Search For Products Categories" Style="font-size: x-large"></asp:Label>
                                        </strong></td>
                                    </tr>
                                    <tr>
                                        <td>
