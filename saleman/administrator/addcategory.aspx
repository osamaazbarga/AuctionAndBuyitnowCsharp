<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addcategory.aspx.cs" Inherits="saleman.administrator.addcategory" MasterPageFile="~/administrator/adminmasterpage.Master" %>
                    ...
                    <asp:View ID="View1" runat="server">
                        ...
                        <tr>
                            <td class="auto-style3"><strong>
                                <asp:Label ID="Label1" runat="server" CssClass="auto-style2" Text="Search For Prodicts Categories" style="font-size: x-large"></asp:Label>
                                </strong></td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <asp:RadioButtonList ID="rdoField" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="id_category">Category Number</asp:ListItem>
                        ...
                        <tr>
                            <td class="auto-style4">
                                <asp:Button ID="btnAdd" runat="server" Enabled="True" Text="Add New" OnClick="btnAdd_Click" />
